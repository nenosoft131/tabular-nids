...
class Utils():
    ...
    # metric
    # def metric(self, y_true, y_score, val_true , val_score, pos_label=1):
    ...
    #     test_accuracy = accuracy_score(y_true, y_score)
    #     test_precision = precision_score(y_true, y_score, zero_division=0)
    #     test_recall = recall_score(y_true, y_score, zero_division=0)
    #     test_f1 = f1_score(y_true, y_score, zero_division=0)
    #     test_f1_macro = f1_score(y_true, y_score, average='macro', zero_division=0)
    #     test_f1_micro = f1_score(y_true, y_score, average='micro', zero_division=0)
    #     test_conf_matrix = confusion_matrix(y_true, y_score)
    ...
    #     val_accuracy = accuracy_score(val_true, val_score)
    #     val_precision = precision_score(val_true, val_score, zero_division=0)
    #     val_recall = recall_score(val_true, val_score, zero_division=0)
    #     val_f1 = f1_score(val_true, val_score, zero_division=0)
    #     val_f1_macro = f1_score(val_true, val_score, average='macro', zero_division=0)
    #     val_f1_micro = f1_score(val_true, val_score, average='micro', zero_division=0)
    #     val_conf_matrix = confusion_matrix(val_true, val_score)
                
                
                
    #     return {'aucroc':test_aucroc, 'aucpr':test_aucpr, 'accuracy':test_accuracy, 'precision':test_precision,
    #             'recall':test_recall,'':test_f1,'':test_f1_macro, '':test_f1_micro, '':test_conf_matrix,
    #             'val_aucroc':val_aucroc, 'val_aucpr':val_aucpr}
    ...
    def metric(self, score_train, anomaly_rate, y_true, y_score, val_true, val_score, pos_label=1):
        ...
        print("y_score:", y_score, "val_score:", val_score)
    ...
    def evaluate_ovr(self, X, y_true, stage='Test'):
        from sklearn.metrics import (
